...
def shape_element(element):
    ...
    if element.tag == "node" or element.tag == "way" :
        ...
        for child in element:
            if child.tag == 'tag':
                ...
                if 'addr:' in address['k']:
                    ...
                    if len(re.findall(r':', address['k'])) > 1:
                        ...
                        node['address'][address['k'][5:]] = address['v']
            ...
            if child.tag == 'nd':
                '''
                Check if node_refs exists in node dictionary. If it doesn't
                create node_refs entry and add the value of nd. Otherwise append
                the value of nd.
                '''
                try:                     
                    if node['node_refs']:
